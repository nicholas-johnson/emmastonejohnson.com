---
title: "How to do transclusion in Angular 2 (ES5)"
...
Of course, because Angular 1 had $scope and two-way binding, there were some fairly significant complexities here to do with the `$scope` of the transcluded content. It was also possible to manually transclude against a `$scope` of your choosing (which is how ng-repeat worked).

This meant that transclusion, neat as it is, unfortunately represented one of the biggest bumps in the Angular 1 learning curve.

%aside.questions_answered

  ## Questions Answered:

  * How do I do transclusion in Angular 2?
  * What are contentChildren in Angular 2?
  * What is the angular 2 equivalent of `ng-transclude`?
  * What does the `ng-content` directive do?


## Angular 2 has contentChildren

Angular 2 does away with the word "transclusion" but retains the spirit and significantly builds on the functionality. Specifically it optionally gives us multiple inclusion points.
...
I said earlier that Angular 2 went beyond Angular 1 by giving you multiple insertion points. Of course, it was possible in Angular 1 to use a link function to create a directive with multiple insertions, but Angular 2 gives us this out of the box.
...
In Angular 1, the $scope of the transclusion was the same as the parent template. From the perspective of an front end designer writing HTML this was eminently sensible, because it meant that the designer would not suddenly find himself inside an isolate scope.
...
## In Angular 2, the contentChildren are bound to their own component

In Angular 2 the this behaviour is preserved. The contentChildren are bound to their own component. Like this:
