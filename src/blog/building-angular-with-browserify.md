---
title: "Organising your Angular code with Browserify"
...
:ruby
  ...
  var catAdminComponent = require("./cat.admin.component");
  var catService = require("./cat.service");
...
:ruby
  ...
  var dogsModule = require('./dogs/cat.module');
